                        ...
                        <form action="{{ route('tasks.update', $task) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="naziv_rada" class="form-control @error('naziv_rada') is-invalid @enderror"
                                       value="{{ old('naziv_rada', $task->naziv_rada) }}" required>
                                @error('naziv_rada')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="naziv_rada_en" class="form-control @error('naziv_rada_en') is-invalid @enderror"
                                       value="{{ old('naziv_rada_en', $task->naziv_rada_en) }}" required>
                                @error('naziv_rada_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="zadatak_rada" rows="4" class="form-control @error('zadatak_rada') is-invalid @enderror" required>{{ old('zadatak_rada', $task->zadatak_rada) }}</textarea>
                                @error('zadatak_rada')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="zadatak_rada_en" rows="4" class="form-control @error('zadatak_rada_en') is-invalid @enderror" required>{{ old('zadatak_rada_en', $task->zadatak_rada_en) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tip_studija" class="form-select @error('tip_studija') is-invalid @enderror" required>
                                    <option value="stručni" {{ old('tip_studija', $task->tip_studija) == 'stručni' ? 'selected' : '' }}>
                                        {{ __('tasks.strucni') }}
                                    </option>
                                    <option value="preddiplomski" {{ old('tip_studija', $task->tip_studija) == 'preddiplomski' ? 'selected' : '' }}>
                                        {{ __('tasks.preddiplomski') }}
                                    </option>
                                    <option value="diplomski" {{ old('tip_studija', $task->tip_studija) == 'diplomski' ? 'selected' : '' }}>
                                        {{ __('tasks.diplomski') }}
                                    </option>
                                </select>
                                @error('tip_studija')
